...
#
base = model._modules.get('base')
print(" base ",base)
final_layer = base._modules.get('layer4')
instance6_fc = model._modules.get('instance6')
print(" base loaded ")
print(" final layer : ",final_layer)
print(" instance6 FC layer ",instance6_fc)
...
def heatmap2d(img, ht_map):
    ...
    plt.show()
    fig.savefig('/content/drive/MyDrive/Spatial-Attention-master/heatmap_demo/fused_sample.jpeg')
...
# fig.savefig('./heatmap/heatmap'+str(i))
heatmap2d(overlay[0],isplay_transform(image))
